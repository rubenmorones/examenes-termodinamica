/**
 * BANCO DE PREGUNTAS TEORÍA - OPCIÓN MÚLTIPLE (ACTUALIZADO)
...
const preguntasTeoria = {
  ...
  2001011: {
    matricula: '2001011',
    pregunta: '¿Cuál es la ecuación correcta para la densidad de flujo de calor en un proceso reversible?',
    opciones: {
      a: 'δQ = TdS + PdV',
      b: 'δQ_rev = TdS (Primera Ley)',
      c: 'δQ = ΔU + PΔV',
      d: 'δQ = dU/dT'
    },
    respuestaCorrecta: 'b',
